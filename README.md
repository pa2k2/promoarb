...
1. Visitor clicks **Subscribe** → your Stripe Payment Link ($9.99/mo).
...
- **Products → Add product**: "PromoArb Pro", recurring, $9.99/month.
...
### 2. This project
- In `public/index.html`, replace `REPLACE_WITH_YOUR_PAYMENT_LINK` with your
  Payment Link URL (search for it — one spot, the `STRIPE_LINK` constant).
